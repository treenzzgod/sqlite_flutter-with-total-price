...
class EntryLuar extends StatefulWidget {
  const EntryLuar({Key? key}) : super(key: key);

  @override
  State<EntryLuar> createState() => _EntryLuarState();
}

class _EntryLuarState extends State<EntryLuar> {
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (date.toString().isNotEmpty &&
                      ...
                      int count = await dbhelper.insertpengeluaran(
                        date,
                        amount,
                        deksripsi,
                      );
